...
STRANGLE_OFFSETS = [50, 100, 150]  # For Long Strangle
WING_WIDTHS = [50, 100, 200]       # For Iron Butterfly protection
RATIO_OFFSETS = [50, 100]          # For Ratio Spreads (Short leg offset from ATM)
